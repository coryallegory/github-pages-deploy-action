...
function deploy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield execute_1.execute(`git commit -m "${!util_1.isNullOrUndefined(constants_1.action.commitMessage)
            ...
            : `Deploying to ${constants_1.action.branch} from ${constants_1.action.baseBranch ? constants_1.action.baseBranch : constants_1.action.defaultBranch}`} - ${process.env.GITHUB_SHA} 🚀" --quiet`, temporaryDeploymentDirectory);
