...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git remote set-url origin ${constants_1.repositoryPath}`, constants_1.workspace);
...
function generateBranch() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield execute_1.execute(`git push origin ${constants_1.action.branch}`, constants_1.workspace);
            yield execute_1.execute(`git fetch`, constants_1.workspace);
        }
        catch (error) {
...
function deploy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        /*
          ...
          */
        const branchExists = yield execute_1.execute(`git ls-remote --heads origin ${constants_1.action.branch} | wc -l`, constants_1.workspace);
        ...
        yield switchToBaseBranch();
        yield execute_1.execute(`git fetch origin`, constants_1.workspace);
        ...
        yield execute_1.execute(`git push --force origin ${temporaryDeploymentBranch}:${constants_1.action.branch}`, temporaryDeploymentDirectory);
